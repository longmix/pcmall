...
<div class="caomeiwei">
    ...
    <!--商品分类-->
    <div class="juziwei">
    	<a href="#" title="上架时间降序排列">新品<br/>新品</a>
        <a href="#" title="销售价格降序排列">价格<br/>价格</a>
        <a href="#" title="七日内销量降序排列">销量<br/>销量</a>
        <a href="#" title="收藏人气降序排列">收藏<br/>收藏</a>
        <a href="#" title="人气降序排列">人气<br/>人气</a>
        <input value="搜索" type="submit" style=" width:50px; height:22px; border:1px solid #d93600; font-size:12px; float:right; margin-top:6px; margin-right:10px; margin-left:2px; color:#fff; background:#d93600">
        <input style=" width:120px; height:20px; border:1px solid #bbb; font-size:12px; margin-top:6px; color:#666; text-indent:6px; float:right" type="text" placeholder="搜索店内的商品" required="">
    </div>
    <!--所有分类-->
    <div class="yansuan">
    	<ul>
