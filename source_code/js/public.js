...
//	console.log(te);
	...
	function moveL(){
		...
		if(i==size){
			$(".lunboimg").css({left:0})
			var clone = $(".lunbobanner .lunboimg li").first().clone();
			$(".lunbobanner .lunboimg li").first().remove();
			$(".lunbobanner .lunboimg").append(clone);
			i=1;
			}
		$(".lunboimg").stop().animate({left:-i*1225},2000)
	...
	function moveR(){
		...
		if(i==-1){
			...
			var clone = $(".lunbobanner .lunboimg li").eq(1).clone();
			$(".lunbobanner .lunboimg li").eq(1).remove();
			$(".lunbobanner .lunboimg").prepend(clone);
			i=size-2;
			}
		$(".lunboimg").stop().animate({left:-i*1225},2000)
		}
